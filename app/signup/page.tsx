...
import { Loader2, AlertCircle, Sparkles, User, Briefcase, Mail, Lock, ShieldCheck, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-12 overflow-hidden font-body text-text-dark select-none bg-white">
      ...
      <div className="lg:col-span-5 flex flex-col justify-between p-8 sm:p-12 lg:p-16 bg-white relative z-10 min-h-screen">
        ...
        {/* Center Form */}
        <div className="max-w-md w-full mx-auto my-auto space-y-6 pt-8 pb-8 text-left">
          <div className="space-y-2">
            <h1 className="text-3xl font-extrabold tracking-tight text-[#0F172A] font-display">
              Create your account
            </h1>
            <p className="text-text-secondary text-sm font-medium leading-relaxed">
              Start generating professional scopes for free today.
            </p>
          </div>
          ...
          <div className="relative flex py-2 items-center">
            ...
            <span className="flex-shrink mx-4 text-xs font-bold text-text-muted uppercase">Or email signup</span>
            <div className="flex-grow border-t border-[#E5EAF2]"></div>
          </div>

          <form onSubmit={handleSignUp} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="fullName" className="block text-xs font-bold text-[#0F172A] uppercase tracking-wider">
                Full Name
              </label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-baseline">
                <label htmlFor="businessName" className="block text-xs font-bold text-[#0F172A] uppercase tracking-wider">
                  Business Name
                </label>
