...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen w-full relative flex flex-col items-center justify-center px-4 py-12 bg-[#F8FAFC] overflow-hidden font-body text-text-dark selection:bg-primary-light">
      ...
      <div className="w-full max-w-md bg-white border border-border-light rounded-[24px] p-8 md:p-10 shadow-[0_12px_40px_rgba(0,0,0,0.03)] relative z-10">
        ...
        <form onSubmit={handleSignUp} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                required
                className="w-full rounded-xl pl-10 pr-4 py-3 text-sm bg-white border border-border-light text-text-dark outline-none focus:border-primary focus:ring-4 focus:ring-primary-light transition-all font-body placeholder:text-text-muted"
          ...
          <div>
            ...
            <p className="text-[10px] mt-1.5 text-text-secondary font-medium">
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                required
                minLength={8}
                className="w-full rounded-xl pl-10 pr-4 py-3 text-sm bg-white border border-border-light text-text-dark outline-none focus:border-primary focus:ring-4 focus:ring-primary-light transition-all font-body placeholder:text-slate-400"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full font-bold text-sm py-3.5 rounded-full transition-all duration-300 shadow-blue mt-4 flex items-center justify-center gap-2 hover:scale-[1.01] active:scale-[0.99]
      ...
      {/* Footer */}
      <p className="mt-8 text-xs text-center text-text-muted max-w-xs leading-normal">
